...
<body onload="onLoad()" style="background-color:white;color:black;" text="black">
<ul class="uk-breadcrumb uk-margin-left" >
			<li><a href="../" style="color:light-grey; font-size:30px;">Home</a></li>
			<li class="uk-disabled"><a href="#" style="color:blackS; font-size:30px;">Hospital Registration</a></li>
			</ul>
	<center><div class="uk-padding-small" >
		<div class="uk-card uk-card-default uk-card-body uk-width-1-2@m" style="border: 2px solid #8e1909">
			<form class="uk-form-width-1-2@m uk-form" action="otp.php?user=hospital" method="POST"  onsubmit="return checkform(this);">

				Hospital Name:<br />
				<input type="text" class="uk-input uk-width-5-6 uk-margin-small" name="name" required>
				...
				Contact Number:<br />
				<input type="text" class="uk-input uk-margin-small uk-width-5-6" pattern="[0-9]{10}$" name="contactnumber" required>
				<span class="required">*</span><br/>
