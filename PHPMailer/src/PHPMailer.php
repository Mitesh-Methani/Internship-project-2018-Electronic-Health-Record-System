...
class PHPMailer
{
     ...
     * ```
     *
     * Alternatively, you can  in an instance of a PSR-3 compatible logger, though only `debug`
     ...
     * claims to be sendmail), don't  params (not a perfect fix,
     * but it will do).
     *
     * @param string      $to      To
     ...
     * Alternatively you may  in a callable to inject your own validator, for example:
     *
     * ```php
    ...
    {
        // CVE-2016-10033, CVE-2016-10045: Don't  -f if characters will be escaped.
