...
$sql = "SELECT hospital_name FROM `hospital` WHERE `hospital_id`='$u'";
$r=mysqli_query($db,$sql);
		if($r){
		$list1=mysqli_fetch_assoc($r);
		echo $list1['hospital_name'][0];
		}
	?>	</b>	
</center></button></li>
</ul>
...
<div id="myModal" class="modal">
  <div class="modal-content">
	...
	<center><b style="font-size:50px;"><?php echo $list1['hospital_name'][0]; ?></b><br><br>
	<?php
	$conn=mysqli_connect("localhost","root","","ehr_healthcare");
	$q="SELECT * FROM hospital WHERE hospital_id = $_SESSION[username]";
	$r=mysqli_query($conn,$q);
	$list=mysqli_fetch_assoc($r);
	echo "Hospital ID: ".$list['hospital_id']."<br>";
	echo "NAME: ".$list['hospital_name']."<br>";
