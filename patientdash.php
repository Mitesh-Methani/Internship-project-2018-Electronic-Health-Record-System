...
<li>|</li>
<li><a href="healthrecord.php">My Health Records</a></li>
<li>|</li>
<li><a href="uploadrec.php">Upload Health Records</a></li>
<li>|</li>
<li><a href="main.php">Privacy and Settings</a></li>
<li>|</li>
...
$sql = "SELECT name FROM `patients` WHERE `uidai`='$u'";
...
<div id="myModal" class="modal">
  <div class="modal-content">
	...
	echo "UIDAI: ".$list['uidai']."<br>";
	echo "NAME: ".$list['name']."<br>";
	echo "E-mail: ".$list['email_id']."<br><br>";
	?>
